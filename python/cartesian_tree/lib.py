...
class Frame:
    ...
    def add_child(
        self, name: str, position: Position, orientation: RPY | Quaternion
    ) -> Frame:
        ...
        Args:
            ...
            rotation: The orientational offset from the parent.
        ...
        binding_frame = self._core_frame.add_child(
            name, position._binding_structure, orientation._binding_structure
        )
    ...
    def add_pose(self, position: Position, orientation: RPY | Quaternion) -> Pose:
        ...
        Args:
            ...
            rotation: The orientational part of the pose.
        ...
        binding_pose = self._core_frame.add_pose(
            position._binding_structure, orientation._binding_structure
        )
    ...
    def update_transformation(
        self, position: Position, orientation: RPY | Quaternion
    ) -> None:
        ...
        if isinstance(orientation, RPY):
            orientation = orientation.to_quaternion()
        self._core_frame.update_transformation(
            position._binding_structure, orientation._binding_structure
        )
    ...
    def children(self) -> list[Frame]:
        return [
            Frame._from_rust(binding_child)
            for binding_child in self._core_frame.children()
        ]
